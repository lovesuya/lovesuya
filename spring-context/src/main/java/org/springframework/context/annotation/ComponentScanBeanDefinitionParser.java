...
/**
 * spring解析自定义标签的时候，会加载到context标签
 * context标签的解析器在spring-context包下面的spring.handlers中
 * ContextNamespaceHandler这解析器初始化，注入component-scan值所对应的解析器就是当前解析器
 * 然后当前解析器的parse会扫描配置的包
 */
