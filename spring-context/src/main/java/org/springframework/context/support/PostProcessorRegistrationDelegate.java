...
final class PostProcessorRegistrationDelegate {
	...
	//此方法也是核心之一，设置默认的beanFactoryPostProcessor,并执行，可以扫描注解，ConfigurationClassPostProcessor
	public static void invokeBeanFactoryPostProcessors(
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			for (BeanFactoryPostProcessor postProcessor : beanFactoryPostProcessors) {
				//BeanDefinitionRegistryPostProcessor目前该接口的实现者为
				// MapperScannerConfigurer/ConfigurationClassPostProcessor
				if (postProcessor instanceof BeanDefinitionRegistryPostProcessor) {
					BeanDefinitionRegistryPostProcessor registryProcessor =
							(BeanDefinitionRegistryPostProcessor) postProcessor;
					//调用postProcessBeanDefinitionRegistry接口，
					// 比如MapperScannerConfigurer则会进行扫描注册接口bean操作
			 ...
			 * 此处断点可知这个类叫做：ConfigurationAnnotationProcessor(这个是springboot的吧)
			 */
			...
			//第二步，处理注册在bean工厂中BeanFactoryPostProcessor接口实现类并调用公用的方法，
			//比如PropertyResourceConfigurer资源文件解析类
